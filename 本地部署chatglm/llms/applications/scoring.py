...
if __name__ == '__main__':
    ...
    data = {
        "{{SRC_VALUE}}": "我将给定一段文本，以及指定的实体中国，抽取与该实体相关的Key-Value知识。以下是文本：中国是一个伟大的国家，5000多年的风雨沧桑孕育出了伟大奋斗、伟大创造、伟大担当、伟大力量等等这些熔铸于民族血脉的伟大基因，烙印于人民心底的伟大精神。",
        "{{TGT_VALUE}}": "实体: 中国 Key-Value知识抽取：-历史: 中国有着5000多年的历史-文化: 中国有伟大奋斗、伟大创造、伟大担当、伟大力量等熔铸于民族血脉的伟大基因-人民: 中国人民心底有烙印着伟大精神",
    }
